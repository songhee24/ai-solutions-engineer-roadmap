 ...
 *
 * Замер 04.09.2026 (сотый день, стодневный журнал, 182 единицы): весь carriedFrom
 * — 1,03 мс за вызов, один plannedOnDay — 0,09 мс, а stats, который и так в пути
 * отрисовки, — 1,47 мс. Оптимизировать здесь нечего: глубина ограничена семью
 * днями по построению, поэтому с ростом журнала цена не растёт.
 */
