...
const DEFAULTS = {
  ...
  startDate: null,
  /** Пятёрка была дефолтом, а не решением, и расходилась с самой картой: там
   *  главный режим meta.defaultPace — 15 ч/нед, то есть 2,1 ч в день. Двойка
   *  приводит планнер к тому, что карта заявляет о себе сама. Шаг поля — 0,5 ч,
   *  поэтому не 2,14. Действует только на чистое хранилище. 05.09.2026. */
  hoursPerDay: 2,
