...
window.ROADMAP = {
  meta: {
    ...
    lede: "Комплексная программа: математика, программирование, данные, машинное обучение, backend, облако и работа с людьми — всё, на чём стоит любая из четырёх профессий. Направление выбирается ближе к концу, когда вы уже попробовали и данные, и модели, и системы.",
    paces: { calm: 8, main: 15, intense: 25 },
    defaultPace: 15,
    defaultProfile: "novice",
    /* Уровень английского задаётся переключателем на треке B и хранится отдельным
       ключом asr:english-level. Значение по умолчанию — замер British Council
       от 03.09.2026: B1 Intermediate. */
    englishLevels: ["a1", "a2", "b1", "b2", "c1"],
  ...
  about: {
    goal: "Собрать полную инженерную базу вокруг AI — от школьной математики до систем в проде — и на ней выбрать одно из четырёх направлений, а не гадать о выборе заранее.",
    jobs: [
      "Data Scientist", "ML Engineer", "AI Engineer", "AI Solutions Engineer",
      "Applied AI Engineer", "LLM Engineer", "Data Analyst", "Solutions Architect (AI)"
    ],
    fallbacks: ["Data Analyst", "Junior AI Engineer", "No-code Automation Specialist"],
    wide: [
    ...
    deep: [
      "Глубина выбирается — карта доводит до развилки и даёт дойти до неё осознанно",
      "Data Science: эксперименты, причинность, прогнозирование, выводы для бизнеса",
      "ML Engineering: пайплайны, реестр моделей, инференс под нагрузкой, дрейф",
      "AI Engineering: LLM-приложения, RAG, агенты, tool calling, MCP, evals",
      "AI Solutions Engineering: всё из AI Engineering плюс discovery, PoC и защита решения"
    ],
    honest: [
      "Это программа общей инженерной базы, а не курс одной профессии. Направление выбирается ближе к этапу 6–7, когда вы уже попробовали и данные, и модели, и системы.",
      ...
      "Ни одна профессия здесь не требует всех 1609 часов до первого отклика на вакансию. Смотрите раздел «Куда дальше»: у каждого направления своё ядро."
    ]
  },
...

{
  ...
  why: "Пока вы не понимаете, чем эти профессии отличаются друг от друга, выбирать между ними невозможно — а выбирать придётся. Заодно это первая проверка: сможете ли вы объяснить незнакомую тему своими словами.",
  prereq: [],
  topics: [
    {
    ...
    },
    {
      ...
      track: "solutions", kind: "theory", hours: { novice: 3, dev: 2 }, required: true,
      resources: [],
      task: "Откройте по 5 реальных вакансий на каждое из четырёх направлений: Data Scientist, ML Engineer, AI Engineer, AI Solutions Engineer. Выпишите требования в одну таблицу и отметьте, что повторяется у всех, а что уникально. Совпадающая часть и есть общая база, ради которой существует эта карта. Это ваш личный gap-анализ, к нему вернётесь на этапе 9."
    },
    {
      ...
      courseNote: "Среда — не только цифровая. К Python, VS Code и Git добавьте тетрадь в клетку, прозрачную линейку 20 см и карандаш с ластиком: математика идёт параллельно с самого начала, и на неё это понадобится в первую же неделю. Почему именно такие — в разделе «Как заниматься».",
  ...
  ready: [
    "Могу за 2 минуты объяснить, чем различаются Data Scientist, ML Engineer, AI Engineer и AI Solutions Engineer",
...

{
  ...
  prereq: ["stage-0"],
  courseNote: "Перед первым юнитом соберите стол: тетрадь в клетку, прозрачная линейка 20 см и карандаш с ластиком. Прозрачная — чтобы в A5 видеть кривую под линейкой, когда проводите касательную; карандаш — чтобы стирать одну строку, а не переписывать пример. Треугольные линейки не нужны: они существуют ради перпендикуляров, а клетка даёт их даром. Подробно — в разделе «Как заниматься».\n\nНИ ОДИН курс Khan Academy здесь не проходится целиком. Ниже у каждой темы указано, сколько в курсе юнитов и какие именно из них нужны. Всего по треку: Arithmetic — 11 юнитов из 19, Pre-algebra — 6 из 15, Algebra basics — 6 из 8, Algebra 1 — 4 из 16, Algebra 2 — 1 из 12, Statistics and probability — 11 из 16, Linear algebra — 2 из 3, Differential calculus — 3 из 6, Multivariable calculus — 1 из 5.\n\nУ 41 ссылки из 45 рядом стоит вторая — RU: та же тема на ru.khanacademy.org. Английская остаётся основной, потому что нумерация юнитов совпадает только с ней. Про русскую версию стоит знать три вещи, все проверены вживую 3 сентября 2026 года. Переведена она выборочно и непредсказуемо: у модуля может быть русское название и полностью английские упражнения — в «Дроби» по-русски ноль упражнений из четырнадцати, а в «Summarizing quantitative data» с английским названием — восемь из четырнадцати. Нарезана она крупнее: девятнадцать английских юнитов «Арифметики» соответствуют пяти русским модулям, поэтому у двенадцати ссылок стоит пометка, куда именно они ведут. И четырёх курсов там нет вовсе — логарифмы, линейная алгебра и многомерные производные существуют только по-английски.",
  topics: [
    /* ---------- A1. Арифметика: дроби, десятичные, отрицательные ---------- */
    {
      ...
      resources: [
        { title: "Khan Academy — Arithmetic, Unit 4: Understand fractions", url: "https://www.khanacademy.org/math/arithmetic/fraction-arithmetic",
          ru: { url: "https://ru.khanacademy.org/math/arithmetic/fraction-arithmetic" },
        ...
        { title: "Khan Academy — Arithmetic, Unit 9: Add and subtract fractions (like denominators)", url: "https://www.khanacademy.org/math/arithmetic/x18ca194a:add-and-subtract-fraction-like-denominators",
          ru: { url: "https://ru.khanacademy.org/math/arithmetic/fraction-arithmetic",
                note: "Русский модуль 4 «Дроби» шире этого юнита — в нём все дроби сразу." },
        ...
        { title: "Khan Academy — Arithmetic, Unit 15: Divide fractions", url: "https://www.khanacademy.org/math/arithmetic/x18ca194a:divide-fractions",
          ...
          skip: "—", checked: "2026-08-23" },
        { title: "Математика с нуля — дроби по-русски (шаги 12–17)", url: "https://spacemath.xyz/drobi/",
          cost: "free", lang: "ru", level: "База", hours: 8, required: false,
          scope: "Шаги 12–17, плюс «Дополнительные сведения о дробях» (38) и «Задачи на дроби» (43)",
          study: "⚠ Русский Khan именно здесь НЕ переведён: в модуле «Дроби» ноль русских упражнений из четырнадцати (проверено 3 сентября 2026). Этот курс переведён целиком: шесть шагов по дробям, отдельная «Практика по дробям», у задач кнопка «Показать решение». Если английский юнит идёт тяжело, проходите тему здесь, а Khan держите ради нумерации и галочек.",
          skip: "Формулы на сайте картинками, ни MathJax, ни KaTeX: текст не копируется, на телефоне мелко. «Показать решение» — это не автопроверка Khan, сверяете сами, поэтому правило «ответ сначала на бумаге» здесь обязательно. Прогресс нигде не считается.", checked: "2026-09-14" }
      ],
    ...
    },
    {
      ...
      resources: [
        { title: "Khan Academy — Arithmetic, Unit 11: Decimals and place value", url: "https://www.khanacademy.org/math/arithmetic/arith-decimals",
          ru: { url: "https://ru.khanacademy.org/math/arithmetic/arith-decimals" },
          cost: "free", lang: "en", level: "База", hours: 4, required: true,
        ...
        { title: "Khan Academy — Arithmetic, Unit 12: Add and subtract decimals", url: "https://www.khanacademy.org/math/arithmetic/x18ca194a:add-and-subtract-decimals",
          ru: { url: "https://ru.khanacademy.org/math/arithmetic/arith-decimals",
                note: "Русский модуль 5 «Десятичные дроби» шире этого юнита." },
          cost: "free", lang: "en", level: "База", hours: 4, required: true,
        ...
        { title: "Khan Academy — Arithmetic, Unit 16: Multiply and divide decimals", url: "https://www.khanacademy.org/math/arithmetic/x18ca194a:multiply-and-divide-decimals",
          ...
          skip: "—", checked: "2026-08-23" },
        { title: "Математика с нуля — десятичные дроби (шаги 18–22)", url: "https://spacemath.xyz/desyatichnie_drobi/",
          cost: "free", lang: "ru", level: "База", hours: 5, required: false,
          scope: "Шаги 18–22 — десятичные дроби, действия, округление, периодические",
          study: "Тот же материал по-русски: разряды, действия в столбик, округление, периодические дроби.",
          skip: "Блока «Задания для самостоятельного решения» на самой странице нет — практика вынесена в отдельный шаг 20 «Практика по десятичным дробям».", checked: "2026-09-14" }
      ],
    ...
    },
    {
      ...
      resources: [
        { title: "Khan Academy — Arithmetic, Unit 18: Add and subtract negative numbers", url: "https://www.khanacademy.org/math/arithmetic/arith-review-negative-numbers",
          ru: { url: "https://ru.khanacademy.org/math/arithmetic/arith-review-negative-numbers" },
          cost: "free", lang: "en", level: "База", hours: 6, required: true,
        ...
        { title: "Khan Academy — Arithmetic, Unit 19: Multiply and divide negative numbers", url: "https://www.khanacademy.org/math/arithmetic/x18ca194a:multiply-and-divide-negative-numbers",
          ru: { url: "https://ru.khanacademy.org/math/arithmetic/arith-review-negative-numbers",
                note: "Русский модуль 3 «Отрицательные числа» шире этого юнита." },
          cost: "free", lang: "en", level: "База", hours: 6, required: true,
          scope: "Unit 19 из 19 — последний юнит курса",
          study: "Правила знаков при умножении и делении.",
          skip: "—", checked: "2026-08-23" },
        { title: "Математика с нуля — отрицательные числа (шаги 29–37)", url: "https://spacemath.xyz/otricatelnie_chisla/",
          cost: "free", lang: "ru", level: "База", hours: 6, required: false,
          scope: "Шаги 29–37 — знаки, модуль, целые и рациональные числа",
          study: "Шире юнитов Khan: после знаков и модуля идут целые и рациональные числа отдельными шагами.",
          skip: "—", checked: "2026-09-14" }
      ],
    ...
    },
    {
      ...
      resources: [
        { title: "Khan Academy — Pre-algebra, Unit 3: Ratios and rates", url: "https://www.khanacademy.org/math/pre-algebra/pre-algebra-ratios-rates",
          ru: { url: "https://ru.khanacademy.org/math/pre-algebra/pre-algebra-ratios-rates" },
        ...
        { title: "Khan Academy — Pre-algebra, Unit 4: Percentages", url: "https://www.khanacademy.org/math/pre-algebra/xb4832e56:percentages",
          ru: { url: "https://ru.khanacademy.org/math/pre-algebra/pre-algebra-ratios-rates",
                note: "Проценты в русской версии лежат внутри модуля 8 «Ratios, rates, proportions»." },
          cost: "free", lang: "en", level: "База", hours: 4, required: true,
        ...
        { title: "Математика с нуля — соотношения, пропорции, проценты (шаги 24–28)", url: "https://spacemath.xyz/sootnosheniya/",
          cost: "free", lang: "ru", level: "База", hours: 6, required: false,
          scope: "Шаги 24–28, плюс «Задачи на проценты» (44) и «Решение задач с помощью пропорции» (50)",
          study: "Соотношения, пропорция, прямая и обратная пропорциональность, проценты — одной цепочкой по-русски.",
          skip: "Практики на самой странице нет: задачи стоят отдельными шагами 44 и 50.", checked: "2026-09-14" }
      ],
    ...
    },
    {
      ...
      resources: [
        { title: "Khan Academy — Arithmetic, Unit 17: Exponents and powers of ten", url: "https://www.khanacademy.org/math/arithmetic/x18ca194a:exponents-and-powers-of-ten",
          ru: { url: "https://ru.khanacademy.org/math/pre-algebra/pre-algebra-exponents-radicals",
                note: "В русской «Арифметике» такого модуля нет; ближайшее — модуль 10 «Степени, корни» из «Начал алгебры»." },
          cost: "free", lang: "en", level: "База", hours: 3, required: true,
        ...
        { title: "Khan Academy — Pre-algebra, Unit 5: Exponents intro and order of operations", url: "https://www.khanacademy.org/math/pre-algebra/xb4832e56:exponents-intro-and-order-of-operations",
          ru: { url: "https://ru.khanacademy.org/math/pre-algebra/pre-algebra-exponents-radicals",
                note: "Русский модуль 10 закрывает степени; порядок действий — в модуле 1 «Некоторые свойства арифметики»." },
          cost: "free", lang: "en", level: "База", hours: 4, required: true,
        ...
        { title: "Математика с нуля — степени и квадратный корень (шаги 55, 56, 64, 65)", url: "https://spacemath.xyz/stepen-s-naturalnym-pokazatelem/",
          cost: "free", lang: "ru", level: "База", hours: 4, required: false,
          scope: "Шаги 55 и 56 (степени), 64 и 65 (квадратный корень)",
          study: "Закрывает степени и корни по-русски.",
          skip: "⚠ Научной записи в этом курсе нет вовсе — её берите только из юнита 11 Pre-algebra выше.", checked: "2026-09-14" }
      ],
    ...
    /* ---------- A2. Алгебра ---------- */
    {
      ...
      resources: [
        ...
        { title: "Khan Academy — Algebra basics, Unit 2: Algebraic expressions", url: "https://www.khanacademy.org/math/algebra-basics/alg-basics-algebraic-expressions",
          ru: { url: "https://ru.khanacademy.org/math/algebra-basics/alg-basics-algebraic-expressions" },
        ...
        { title: "Khan Academy — Algebra basics, Unit 3: Linear equations and inequalities", url: "https://www.khanacademy.org/math/algebra-basics/alg-basics-linear-equations-and-inequalities",
          ru: { url: "https://ru.khanacademy.org/math/algebra-basics/alg-basics-linear-equations-and-inequalities" },
        ...
        { title: "Khan Academy — Algebra 1, Unit 2: Solving equations & inequalities", url: "https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:solve-equations-inequalities",
          ru: { url: "https://ru.khanacademy.org/math/algebra/x2f8bb11595b61c86:solve-equations-inequalities" },
        ...
        { title: "Математика с нуля — буквенные выражения и уравнения (шаги 39–41, 48, 49)", url: "https://spacemath.xyz/bukvennye-vyrazheniya/",
          ...
          study: "Переменные, вынесение общего множителя, раскрытие скобок, затем уравнения и задачи через уравнение — по-русски.",
          skip: "Систем уравнений здесь нет: они дальше по курсу (шаг 51) и относятся к теме A2.3.", checked: "2026-09-14" },
        { title: "Математика с нуля — школьная алгебра сверх пути (шаги 58–74)", url: "https://spacemath.xyz/odnochleny/",
          cost: "free", lang: "ru", level: "Средний", hours: 20, required: false,
          scope: "Шаги 58–74 — ВНЕ пути карты",
          study: "⚠ Это сверх карты: в дневные минуты плана НЕ входит и в срок не заложено. Захотите беглости в алгебре — выделяйте на это отдельное время, а не часы плана. Внутри: одночлены и многочлены, формулы сокращённого умножения, разложение на множители, деление многочленов, квадратный корень и квадратные уравнения, теорема Виета, уравнения и неравенства с модулем.",
          skip: "На путь к AI этот блок не работает: линейная алгебра и производные — это темы A4 и A5, и они из других источников. Семнадцать шагов при нынешнем темпе — около трёх месяцев, поэтому берите их только как осознанную добавку.", checked: "2026-09-14" }
      ],
    ...
    },
    {
      ...
      resources: [
        { title: "Khan Academy — Algebra basics, Unit 4: Graphing lines and slope", url: "https://www.khanacademy.org/math/algebra-basics/alg-basics-graphing-lines-and-slope",
          ru: { url: "https://ru.khanacademy.org/math/algebra-basics/alg-basics-graphing-lines-and-slope" },
        ...
        { title: "Khan Academy — Algebra 1, Unit 5: Forms of linear equations", url: "https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:forms-of-linear-equations",
          ru: { url: "https://ru.khanacademy.org/math/algebra/x2f8bb11595b61c86:forms-of-linear-equations" },
    ...
    },
    {
      ...
      resources: [
        ...
        { title: "Khan Academy — Algebra basics, Unit 5: Systems of equations", url: "https://www.khanacademy.org/math/algebra-basics/alg-basics-systems-of-equations",
          ru: { url: "https://ru.khanacademy.org/math/algebra-basics/alg-basics-systems-of-equations" },
          cost: "free", lang: "en", level: "База", hours: 8, required: true,
    ...
    },
    {
      ...
      resources: [
        { title: "Khan Academy — Algebra basics, Unit 6: Expressions with exponents", url: "https://www.khanacademy.org/math/algebra-basics/alg-basics-expressions-with-exponents",
          ru: { url: "https://ru.khanacademy.org/math/algebra-basics/alg-basics-expressions-with-exponents" },
          cost: "free", lang: "en", level: "База", hours: 4, required: true,
        ...
        { title: "Khan Academy — Algebra 1, Unit 12: Exponential growth & decay", url: "https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:exponential-growth-decay",
          ru: { url: "https://ru.khanacademy.org/math/algebra/x2f8bb11595b61c86:exponential-growth-decay" },
    ...
    /* ---------- A3. Статистика и вероятность ---------- */
    {
      ...
      resources: [
        { title: "Khan Academy — Statistics, Unit 3: Summarizing quantitative data", url: "https://www.khanacademy.org/math/statistics-probability/summarizing-quantitative-data",
          ru: { url: "https://ru.khanacademy.org/math/statistics-probability/summarizing-quantitative-data" },
          cost: "free", lang: "en", level: "База", hours: 8, required: true,
        ...
        { title: "Khan Academy — Statistics, Unit 1: Analyzing categorical data", url: "https://www.khanacademy.org/math/statistics-probability/analyzing-categorical-data",
          ru: { url: "https://ru.khanacademy.org/math/statistics-probability/analyzing-categorical-data" },
          cost: "free", lang: "en", level: "База", hours: 3, required: false,
        ...
        { title: "Khan Academy — Statistics, Unit 2: Displaying and comparing quantitative data", url: "https://www.khanacademy.org/math/statistics-probability/displaying-describing-data",
          ru: { url: "https://ru.khanacademy.org/math/statistics-probability/displaying-describing-data" },
          cost: "free", lang: "en", level: "База", hours: 3, required: false,
    ...
    },
    {
      ...
      resources: [
        { title: "Khan Academy — Statistics, Unit 4: Modeling data distributions", url: "https://www.khanacademy.org/math/statistics-probability/modeling-distributions-of-data",
          ru: { url: "https://ru.khanacademy.org/math/statistics-probability/modeling-distributions-of-data" },
          cost: "free", lang: "en", level: "Средний", hours: 6, required: true,
        ...
        { title: "Khan Academy — Statistics, Unit 5: Exploring bivariate numerical data", url: "https://www.khanacademy.org/math/statistics-probability/describing-relationships-quantitative-data",
          ru: { url: "https://ru.khanacademy.org/math/statistics-probability/describing-relationships-quantitative-data" },
          cost: "free", lang: "en", level: "Средний", hours: 6, required: true,
    ...
    },
    {
      ...
      resources: [
        { title: "Khan Academy — Statistics, Unit 7: Probability", url: "https://www.khanacademy.org/math/statistics-probability/probability-library",
          ru: { url: "https://ru.khanacademy.org/math/statistics-probability/probability-library" },
        ...
        { title: "Khan Academy — Statistics, Unit 9: Random variables", url: "https://www.khanacademy.org/math/statistics-probability/random-variables-stats-library",
          ru: { url: "https://ru.khanacademy.org/math/statistics-probability/random-variables-stats-library" },
    ...
    },
    {
      ...
      resources: [
        { title: "Khan Academy — Statistics, Unit 6: Study design", url: "https://www.khanacademy.org/math/statistics-probability/designing-studies",
          ru: { url: "https://ru.khanacademy.org/math/statistics-probability/designing-studies" },
        ...
        { title: "Khan Academy — Statistics, Unit 10: Sampling distributions", url: "https://www.khanacademy.org/math/statistics-probability/sampling-distributions-library",
          ru: { url: "https://ru.khanacademy.org/math/statistics-probability/sampling-distributions-library" },
    ...
    },
    {
      ...
      resources: [
        { title: "Khan Academy — Statistics, Unit 11: Confidence intervals", url: "https://www.khanacademy.org/math/statistics-probability/confidence-intervals-one-sample",
          ru: { url: "https://ru.khanacademy.org/math/statistics-probability/confidence-intervals-one-sample" },
          cost: "free", lang: "en", level: "Средний", hours: 8, required: true,
        ...
        { title: "Khan Academy — Statistics, Unit 12: Significance tests (hypothesis testing)", url: "https://www.khanacademy.org/math/statistics-probability/significance-tests-one-sample",
          ru: { url: "https://ru.khanacademy.org/math/statistics-probability/significance-tests-one-sample" },
    ...
    /* ---------- A5. Минимальный calculus ---------- */
    {
      ...
      resources: [
        ...
        { title: "Khan Academy — Differential calculus, Unit 1: Limits and continuity", url: "https://www.khanacademy.org/math/differential-calculus/dc-limits",
          ru: { url: "https://ru.khanacademy.org/math/differential-calculus/dc-limits" },
          cost: "free", lang: "en", level: "Средний", hours: 3, required: false,
        ...
        { title: "Khan Academy — Differential calculus, Unit 2: Derivatives: definition and basic rules", url: "https://www.khanacademy.org/math/differential-calculus/dc-diff-intro",
          ru: { url: "https://ru.khanacademy.org/math/differential-calculus/dc-diff-intro" },
          cost: "free", lang: "en", level: "Средний", hours: 7, required: true,
    ...
    },
    {
      ...
      resources: [
        { title: "Khan Academy — Differential calculus, Unit 3: Chain rule", url: "https://www.khanacademy.org/math/differential-calculus/dc-chain",
          ru: { url: "https://ru.khanacademy.org/math/differential-calculus/dc-chain" },
...

{
  ...
  why: "Документация, статьи, курсы, переписка с коллегами и техническое демо — всё на английском в любой из четырёх профессий. Это не «бонус к резюме», а рабочий инструмент, без которого половина материалов карты недоступна.",
  prereq: [],
  ...
  topics: [
    {
      ...
      resources: [
        { title: "British Council — Level test", url: "https://learnenglish.britishcouncil.org/level",
          /* Единственный ресурс, после которого спрашивают результат: планнер
             показывает под ним выбор уровня, пока уровень не задан. Флагом, а
             не сверкой id в интерфейсе — иначе переименование темы это сломает. */
          levelProbe: true,
          cost: "free", lang: "en", level: "База", hours: 1, required: true,
      ...
      task: "Пройдите тест уровня, запишите результат и дату в learning-log и поставьте свой уровень переключателем в шапке трека — ссылки на грамматику, лексику и слушание подстроятся под него. Установите Anki, заведите колоду Tech English и внесите первые 10 слов из документации, которую читали на этой неделе."
    },
    {
    ...
    },
    {
      ...
      resources: [
        ...
        { title: "British Council — Grammar по вашему уровню", url: "https://learnenglish.britishcouncil.org/free-resources/grammar/b1-b2",
          /* У British Council грамматика разбита на три страницы, а не на пять:
             A1-A2, B1-B2 и C1. Проверено вживую 03.09.2026. */
          byLevel: {
            a1: "https://learnenglish.britishcouncil.org/free-resources/grammar/a1-a2",
            a2: "https://learnenglish.britishcouncil.org/free-resources/grammar/a1-a2",
            b1: "https://learnenglish.britishcouncil.org/free-resources/grammar/b1-b2",
            b2: "https://learnenglish.britishcouncil.org/free-resources/grammar/b1-b2",
    ...
    },
    {
      ...
      resources: [
        { title: "Google — Technical Writing One", url: "https://developers.google.com/tech-writing/one",
          ...
          skip: "—", checked: "2026-08-23" },
        { title: "British Council — Vocabulary по вашему уровню", url: "https://learnenglish.britishcouncil.org/free-resources/vocabulary/b1-b2",
          /* Страницы C1 у лексики нет — проверено вживую 03.09.2026, отдаёт
             «Page not found». Поэтому на C1 ведём на ту же B1-B2. */
          byLevel: {
            a1: "https://learnenglish.britishcouncil.org/free-resources/vocabulary/a1-a2",
            a2: "https://learnenglish.britishcouncil.org/free-resources/vocabulary/a1-a2",
            b1: "https://learnenglish.britishcouncil.org/free-resources/vocabulary/b1-b2",
            b2: "https://learnenglish.britishcouncil.org/free-resources/vocabulary/b1-b2",
            c1: "https://learnenglish.britishcouncil.org/free-resources/vocabulary/b1-b2"
          },
          cost: "free", lang: "en", level: "Средний", hours: 6, required: false,
          scope: "Упражнения по своему уровню",
    ...
    },
    {
      ...
      courseNote: "Последний и самый некомфортный кусок. Здесь нужен не словарь, а километраж: слушать и говорить, пока не перестанете спотыкаться. Для всех четырёх направлений это не опция: защита решения, разбор задачи с заказчиком и собеседование идут голосом.",
      resources: [
        { title: "British Council — Listening по вашему уровню", url: "https://learnenglish.britishcouncil.org/free-resources/listening/b1",
          /* Единственный раздел с отдельной страницей на каждый уровень.
             Все пять проверены вживую 03.09.2026. */
          byLevel: {
            a1: "https://learnenglish.britishcouncil.org/free-resources/listening/a1",
            a2: "https://learnenglish.britishcouncil.org/free-resources/listening/a2",
            b1: "https://learnenglish.britishcouncil.org/free-resources/listening/b1",
            b2: "https://learnenglish.britishcouncil.org/free-resources/listening/b2",
            c1: "https://learnenglish.britishcouncil.org/free-resources/listening/c1"
          },
          cost: "free", lang: "en", level: "Средний", hours: 12, required: true,
          scope: "Записи с расшифровками, страница подставляется по вашему уровню",
          ...
          skip: "Ссылка уже ведёт на ваш уровень — ниже него не спускайтесь.", checked: "2026-09-03" },
      ...
      task: "Запишите 5-минутное демо одного своего проекта на английском. Не читайте с листа. Пересматривайте и переснимайте, пока не перестанете спотыкаться, — обычно нужно 5–8 дублей, и это нормально. Демо своей работы просят на собеседовании в любой из четырёх профессий, и лучше провалить его дома на камеру, чем на звонке."
    }
  ],
  project: {
...

{
  ...
  why: "Любая рабочая AI-система соединяет чужие сервисы: система А ↔ API ↔ ваш сервис ↔ LLM ↔ база ↔ система Б. Этот трек даёт ту же механику быстрее и без кода — и заодно открывает соседнюю профессию, где платят уже сейчас, пока основная специализация ещё строится.",
  prereq: [],
  courseNote: "⚠ Честная рамка. Это НЕ путь ни к одному из четырёх направлений карты — это соседняя профессия с общим инструментарием. Пример реальной вакансии (The Hello Team, август 2026): Remote No-Code Automation & Systems Specialist, 1800–2200 долларов в месяц удалённо, требуются Monday.com, ClickUp, Airtable, Softr, Make.com, работа с ChatGPT/Claude/Gemini и обязательные Loom + Scribe к каждой сдаче. Порог входа — 3 года в no-code, а НЕ в разработке. Отсюда смысл трека: он может дать доход раньше, чем закончится основная карта, и при этом каждая тема здесь пересекается с этапом 4 (HTTP, API, OAuth, ретраи) и этапом 6 (LLM внутри рабочего процесса). Если трек вам не нужен — отметьте его темы кнопкой «Уже знаю», и он исчезнет из плана.",
  topics: [
    {
...

{
  ...
  why: "Python — язык, на котором собирается всё остальное: пайплайны данных, ML-модели, RAG, агенты и сервисы. Во всех четырёх профессиях прототип пишут сами, а не ждут разработчика.",
...

{
  ...
  why: "«У нас есть данные» — фраза, с которой начинается почти любой проект. Дальше выясняется, что данных мало, они противоречивы и половина пропущена. Умение быстро понять, что это за данные и где они врут, нужно одинаково всем четырём профессиям.",
  prereq: ["stage-1"],
  topics: [
    {
...

{
  ...
  why: "Это ядро профессии Data Scientist и обязательная база для всех остальных. Половина задач, которые называют «AI», решается градиентным бустингом на табличных данных — дешевле, быстрее и предсказуемее, чем через LLM. Уметь распознать такой случай важнее умения запустить модель.",
  ...
  topics: [
    {
      ...
      resources: [
        ...
        { title: "Kaggle Learn — Intro to Machine Learning", url: "https://www.kaggle.com/learn/intro-to-machine-learning",
          ...
          skip: "—", checked: "2026-08-23" },
        { title: "Tanu-N-Prabhu/Python — 11 законченных ML-проектов", url: "https://github.com/Tanu-N-Prabhu/Python/tree/master/Machine%20Learning/05_projects",
          cost: "free", lang: "en", level: "Средний", hours: 3, required: false,
          scope: "Только папка Machine Learning/05_projects — не весь репозиторий",
          study: "Эталон ФОРМЫ законченного проекта, а не учебник: как выглядит путь от сырого CSV до сохранённой модели целиком. Все одиннадцать собраны одним скелетом — загрузка, EDA, очистка, разбиение, обучение, метрики, сохранение, выводы. Прочитайте два-три перед проектом этапа и сравните этот скелет со своим.",
          skip: "⚠ Лицензии у репозитория нет: читать можно, копировать код в своё портфолио нельзя. И сами проекты не дотягивают до требований вашего проекта этапа — в «Customer Churn Prediction» нет тупого baseline, а моделей две, не три. Скелет берите, эти пропуски — нет. Остальной репозиторий пропустите: оглавление README битое с декабря 2025, а базовые темы по Python там — короткие статьи без упражнений.",
          checked: "2026-09-11" }
      ],
...

{
  ...
  why: "Модель в ноутбуке не стоит ничего, пока к ней нельзя обратиться. Всё, что вы будете соединять, разговаривает по HTTP: чужой API, чужая база, чужая аутентификация. Этот этап превращает вас из «человека с ноутбуком» в инженера, который отдаёт работающий сервис — и он обязателен и для ML Engineer, и для AI Engineer.",
  prereq: ["stage-1"],
  topics: [
    {
  ...
  topics: [
    {
      ...
      ,
        { title: "Anthropic — Structured outputs", url: "https://platform.claude.com/docs/en/build-with-claude/structured-outputs",
          cost: "free", lang: "en", level: "Средний", hours: 3, required: false,
          scope: "Углублённо, вне обязательного пути",
          study: "Ответ по схеме у первого провайдера: как описать форму и что делать, когда модель из неё выпадает.",
          skip: "—", checked: "2026-09-03" },
        { title: "Gemini API — структурированный вывод", url: "https://ai.google.dev/gemini-api/docs/structured-output",
          cost: "free", lang: "en", level: "Средний", hours: 2, required: false,
          scope: "Углублённо, вне обязательного пути",
          study: "Тот же примитив у второго провайдера — ровно то сравнение, ради которого в теме три вендора.",
          skip: "—", checked: "2026-09-03" },
        { title: "Gemini API — стратегии промптинга", url: "https://ai.google.dev/gemini-api/docs/prompting-strategies",
          cost: "free", lang: "en", level: "Средний", hours: 3, required: false,
          scope: "Углублённо, вне обязательного пути",
          study: "Правила промптинга от третьего производителя модели: видно, что общее, а что вендорское.",
          skip: "—", checked: "2026-09-03" },
        { title: "Anthropic — причины остановки генерации", url: "https://platform.claude.com/docs/en/build-with-claude/handling-stop-reasons",
          cost: "free", lang: "en", level: "Средний", hours: 2, required: false,
          scope: "Углублённо, вне обязательного пути",
          study: "Почему ответ оборвался: лимит токенов, стоп-последовательность, вызов инструмента. Без этого стриминг ломается молча.",
          skip: "—", checked: "2026-09-03" },
        { title: "Anthropic — подсчёт токенов", url: "https://platform.claude.com/docs/en/build-with-claude/token-counting",
          cost: "free", lang: "en", level: "База", hours: 1, required: false,
          scope: "Углублённо, вне обязательного пути",
          study: "Посчитать длину запроса до отправки — основа и для лимитов контекста, и для стоимости.",
          skip: "—", checked: "2026-09-03" },
        { title: "OpenAI — Responses API (справочник)", url: "https://developers.openai.com/api/reference/resources/responses/",
          cost: "free", lang: "en", level: "Средний", hours: 3, required: false,
          scope: "Углублённо, вне обязательного пути",
          study: "Нынешняя основная форма запроса у OpenAI. Сверять со своим слоем-обёрткой, а не читать подряд.",
          skip: "—", checked: "2026-09-03" }
      ],
    ...
    },
    {
      ...
      ,
        ...
        { title: "OpenAI — Moderation API", url: "https://developers.openai.com/api/docs/guides/moderation",
          ...
          skip: "—", checked: "2026-09-02" }
      ,
        { title: "Learn Prompting — защита от prompt injection", url: "https://learnprompting.org/docs/prompt_hacking/defensive_measures/introduction",
          cost: "free", lang: "en", level: "Продвинутый", hours: 3, required: false,
          scope: "Углублённо, вне обязательного пути",
          study: "Разбор защитных приёмов по одному, с честной оценкой, какой из них чего стоит.",
          skip: "—", checked: "2026-09-03" }
      ],
...

{
  ...
  why: "Именно этот этап отличает AI Solutions Engineer от AI Engineer — и он же полезен всем остальным. Технически сильный инженер, который не умеет выяснить настоящую задачу и защитить решение, останется исполнителем. Умеющий — станет тем, кто определяет, что вообще строить.",
  prereq: ["stage-6"],
  topics: [
    {
...
window.ROADMAP.studyMethod = {
  ...
  tools: {
    title: "Чем писать",
    intro: "Список короткий, и каждый пункт здесь по причине, а не для полноты набора.",
    items: [
      {
        what: "Тетрадь в клетку",
        why: "Клетка нужна не для аккуратности, а для работы: в столбик считают по клеткам, а график без сетки рисуется на глаз и врёт. На линейке и то и другое разъезжается."
      },
      {
        what: "Линейка прозрачная, 20 см",
        why: "Прозрачность здесь не про красоту. В A5 вы проводите касательную к кривой — чтобы приложить линейку по наклону, кривую надо видеть ПОД ней; непрозрачная закрывает ровно точку касания, ради которой всё и рисуется. 30 см не влезает в тетрадь и свисает со стола, металлическая — инструмент для резки, а не для математики."
      },
      {
        what: "Карандаш HB и мягкий ластик",
        why: "В математике стирают много. Ошиблись в третьей строке столбика — стёрли её и продолжили; ручка заставляет переписывать пример целиком, и на этом ломается ход мысли. Карандаш здесь не про черновик, а про право ошибаться дёшево."
      }
    ],
    note: "Больше ничего не нужно, и это проверено по содержанию карты. Треугольные линейки-угольники существуют ради перпендикуляров и фиксированных углов — но перпендикуляры даёт клетка, а углов в градусах в треке нет вовсе. Циркуль и транспортир не понадобятся по той же причине: школьная геометрия исключена явно, в алгебре юниты про неё помечены как ненужные для ML."
  },

  /* Блоки ниже отвечают на вопрос «где нужна бумага» — по трекам и по типам
     записей. Этот отвечает на другой: в какой момент внутри одного урока Khan
     берут ручку. Khan этого не скажет никогда: он спроектирован так, чтобы всё
     решалось в браузере — видео, задачи с подсказками, мгновенная проверка. */
  walkthrough: {
    title: "День 1 по шагам",
    intro: "Ниже — один настоящий день, от первого видео до последних десяти минут английского. Правила из соседних блоков стоят здесь в тот момент, когда они срабатывают.",
    steps: [
      {
        when: "Откуда начинать",
        what: "День 1 по карте — юнит 4 «Дроби» курса Arithmetic. Кнопка Khan «продолжить» может увести в другой юнит: она помнит, где вы остановились, а не что назначено. Пройти лишнее не вредно, но карту это не двигает — галочки тут ставите вы сами."
      },
      {
        when: "Первое видео — тетрадь закрыта",
        what: "Смотрите целиком и ничего не записываете. Цель этого прохода — понять идею, а не законспектировать. Конспект видео — самая бесполезная запись из возможных: он повторяет то, что и так лежит по ссылке."
      },
      {
        when: "Видео начало разбирать пример — пауза",
        what: "Останавливаете ДО того, как автор досчитает. Решаете сами на бумаге, потом досматриваете и сверяете. Это единственное место в видео, где нужна ручка, и самое важное: разобранный на экране пример ощущается точно так же, как умение решить самому."
      },
      {
        when: "Перешли к задачам — тетрадь открыта с первой",
        what: "Правило одно и оно всё держит: ответ сначала на бумаге, потом в поле. У Khan подсказки и мгновенная проверка, и без этого правила вы незаметно съезжаете с «решаю» на «подбираю, пока не примет»."
      },
      {
        when: "Задача решается в уме",
        what: "Всё равно пишете, но только ответ, одной строкой. Смысл не в вычислении, а в том, чтобы рука не выпадала из работы: она набирает те же километры, что и голова."
      },
      {
        when: "Ошиблись — не стираете",
        what: "Рядом пишете верное решение и одним словом, где сломалось: знак, знаменатель, перенос. Через неделю эти пометки сами покажут, что повторять, — и это единственный список ошибок, который у вас будет честным."
      },
      {
        when: "Khan поставил галочку за юнит",
        what: "Это ещё не конец юнита. Закройте вкладку и решите две задачи из него на чистом листе, без подсказок и без поля с проверкой. Не вышло — возвращайтесь к задачам, сколько бы галочек Khan ни поставил."
      },
      {
        when: "Английский — в тот же день, а не «когда математика закончится»",
        what: "Материал для него у вас уже есть: те самые видео Khan, которые вы смотрели утром. Отдельного учебника на старте не нужно — нужен источник, который вы и так читаете по делу."
      },
      {
        when: "Первые 10 минут английского — Anki",
        what: "В колоду идут только слова, встреченные сегодня. Слово выписываете рукой в тетрадь вместе с предложением, откуда взяли, и только потом заводите карточку. Рука кодирует, Anki удерживает."
      },
      {
        when: "Вторые 10 минут — второй проход",
        what: "То, что утром поняли по-русски, пересматриваете или перечитываете по-английски. Не переводите: вы узнаёте знакомую мысль и забираете слова, которыми она сказана. Это и есть правило двух проходов из темы B1."
      },
      {
        when: "Грамматику пока не трогаете",
        what: "Она в теме B3 и нужна для письма и речи, а не для чтения курсов. Сейчас задача одна — понимать. Возьмётесь за грамматику раньше времени — потратите месяцы на то, что чтению почти не помогает."
      }
    ],
    note: "Дальше этот порядок не меняется. Меняется только пауза на разборе примера: чем увереннее считаете, тем реже она нужна, и к концу трека A1 она сходит на нет сама."
  },
  ...
  areas: [
    {
      ...
      need: [
        ...
        "A4 (векторы, матрицы) — рисовать по линейке. Вектор как стрелка, умножение матриц по клеточкам. Тот случай, когда картинка на бумаге и есть понимание.",
        "A5 (производная, градиент) — рисовать наклон касательной руками, прозрачной линейкой: её прикладывают к кривой и поворачивают, пока не совпадёт с наклоном в точке. Один раз нарисовал — и «производная = скорость изменения» перестаёт быть фразой."
      ],
      skip: [
