...

{
  ...
  topics: [
    ...
    },
    {
      ...
      courseNote: "Это не ресурс, а рабочий приём — главный ответ на вопрос «как учиться по английским курсам, если английский слабый». Суть: никогда не боритесь с новой темой и новым языком одновременно. Разведите их во времени.",
      resources: [
        { title: "MDN — HTTP на русском (пример параллельной версии)", url: "https://developer.mozilla.org/ru/docs/Web/HTTP",
          cost: "free", lang: "ru", level: "База", hours: 4, required: true,
          scope: "Пример приёма, а не отдельная тема",
          study: "Откройте русскую версию, разберитесь в теме, затем откройте ту же страницу на /en-US/ и перечитайте. У MDN русские переводы есть у большинства ключевых страниц.",
          skip: "Не читайте обе версии одновременно в двух окнах — глаз всегда уйдёт в русский.", checked: "2026-08-23" },
        { title: "Simple English Wikipedia", url: "https://simple.wikipedia.org/",
          cost: "free", lang: "en", level: "База", hours: 3, required: false,
          scope: "Только статьи по вашим текущим темам",
          study: "Когда русского перевода нет, ищите тему здесь: те же понятия, но словарём в 2000 слов. Хороший промежуточный шаг перед оригиналом.",
          skip: "—", checked: "2026-08-23" }
      ],
      task: "Возьмите одну тему недели и проведите её через два прохода. Первый — по-русски (перевод, статья, видео с русскими субтитрами), пока не поймёте суть. Второй — тот же материал в оригинале, но уже зная смысл: теперь вы не расшифровываете текст, а прикрепляете английские слова к понятому. Запишите в learning-log, сколько времени занял каждый проход. Через 3–4 месяца первый проход начнёт отмирать сам — это и есть критерий перехода на чистый оригинал."
    },
    {
