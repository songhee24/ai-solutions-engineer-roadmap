...
window.ROADMAP.studyMethod = {
  ...
  tools: {
    ...
    note: "Больше ничего не нужно. Циркуль и транспортир не понадобятся: школьная геометрия из карты исключена явно — в алгебре юниты про неё помечены как ненужные для ML."
  },
  areas: [
    {
